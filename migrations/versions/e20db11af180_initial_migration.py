...
Revision ID: e20db11af180
Revises: 
Create Date: 2025-02-26 11:12:46.586475
...
def upgrade():
    ...
    sa.Column('default_menu', sa.String(length=10), nullable=False),
    ...
    op.create_table('simple_menu',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('menu_title', sa.String(length=200), nullable=False),
